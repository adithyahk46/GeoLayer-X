...
ToolBarManager::ToolBarManager()
{
    ...
    QAction* _newProjectAction = new QAction(QIcon(":/resources/icons/project/newfolder.png"),"New Project", this );
    QAction* openAction = new QAction(QIcon(":/resources/icons/project/open_folder.png"), "Open Project",this);
    QAction* saveAction = new QAction(QIcon(":/resources/icons/project/save_project.png"), "Save",this);
    QAction* _printAction = new QAction(QIcon(":/resources/icons/project/print.png"), "Print Layout",this);
