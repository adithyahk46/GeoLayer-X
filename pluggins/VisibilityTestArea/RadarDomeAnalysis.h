#ifndef RADARDOMEANALYSIS_H
#define RADARDOMEANALYSIS_H
...
class RadarDomeAnalysis
{

public:
    RadarDomeAnalysis(osg::Group* sceneRoot, osgViewer::Viewer* viewer, osg::Vec3 lightSource, int radius);
    ~RadarDomeAnalysis();
